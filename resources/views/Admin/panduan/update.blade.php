        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.25s">
                        <form id="contact" action="{{ route('Admin.panduan.update', $panduan->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-lg-6 offset-lg-3">
                                    <div class="section-heading">
                                        <h2><span>Edit Panduan</span></h2>
                                    </div>
                                </div>
                                <div class="col-lg-9">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <fieldset>
                                                <input type="text" name="judul" class="form-control" id="judul" value="{{ old('judul', $panduan->judul) }}" required>
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-12">
                                            <fieldset>
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset>
                                                <div class="main-blue-button">
                                                    ...
                                                    <a href="{{ route('Admin.panduan.panduan') }}">Back</a>
                                                </div>
                                            </fieldset>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-3">
                                    <div class="contact-info">
                                        <div class="icon">
                                            <img src="{{ asset('assets/images/panduan.jpg') }}" alt="email icon">
                                        </div>
                                        <br>
                                        <ul>
                                            <li><a href="#">Edit panduan</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
