        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.25s">
                    <form id="contact" action="{{ route('Admin.brosur.update', $brosur->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-6 offset-lg-3">
                                <div class="section-heading">
                                    <h2><span>Edit Brosur</span></h2>
                                </div>
                            </div>
                            <div class="col-lg-9">
                                <div class="row">
                                        <div class="col-lg-12">
                                            <fieldset>
                                            <input type="text" name="judul" class="form-control" id="judul" value="{{ old('judul', $brosur->judul) }}" required>
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-6">
                                            <fieldset>
                                                ...
                                                @if ($brosur->gambar)
                                                <img src="{{ asset($brosur->gambar) }}" alt="Gambar Brosur" style="width: 100px; height: auto;">
                                                @endif
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-6">
                                            <fieldset>
                                                <i>Abaikan jika tidak merubah gambar</i>
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-12">
                                            <fieldset>
                                                <div class="main-blue-button">
                                                    ...
                                                    <a href="{{ route('Admin.brosur.brosur') }}">Back</a>
                                                </div>
                                            </fieldset>
                                        </div>
                                </div>
